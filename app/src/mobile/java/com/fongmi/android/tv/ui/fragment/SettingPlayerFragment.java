...
import com.fongmi.android.tv.ui.dialog.DefaultFrameRateDialog;
...
public class SettingPlayerFragment extends BaseFragment implements UaListener, SpeedListener {
    ...
    private void onScale(View view) {
        showDialog(new MaterialAlertDialogBuilder(requireActivity()).setTitle(R.string.player_scale).setNegativeButton(R.string.dialog_negative, null).setSingleChoiceItems(scale, PlayerSetting.getScale(), (dialog, which) -> {
    ...
    private void onBackground(View view) {
        showDialog(new MaterialAlertDialogBuilder(requireActivity()).setTitle(R.string.player_background).setNegativeButton(R.string.dialog_negative, null).setSingleChoiceItems(background, PlayerSetting.getBackground(), (dialog, which) -> {
    ...
    private void onAutoFrameRate(View view) {
        showDialog(new MaterialAlertDialogBuilder(requireActivity()).setTitle(R.string.player_auto_frame_rate).setNegativeButton(R.string.dialog_negative, null).setSingleChoiceItems(autoFrameRate, PlayerSetting.getAutoFrameRate(), (dialog, which) -> {
    ...
    private void onDisplayModes(View view) {
        DefaultFrameRateDialog.show(requireActivity(), this::refreshDefaultFrameRateText);
    }

    private void refreshDefaultFrameRateText() {
        mBinding.displayModesText.setText(DefaultDisplayModeManager.getSettingText(requireActivity()));
    }
